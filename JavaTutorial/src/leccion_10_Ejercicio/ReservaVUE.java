...
public class ReservaVUE extends Reserva {
	...
	{
		apSalida = "PMI"; // Valor por defecto
	}
	...
	public ReservaVUE(String pax1, String pax2, String pax3, String pax4, String fInicio, String fFin, String Ap1,
			String Ap2, int neto) {
		...
		this.apSalida = Ap1.toUpperCase();
		this.apSalida = Ap2.toUpperCase();
