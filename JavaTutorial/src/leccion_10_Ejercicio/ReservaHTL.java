...
public class ReservaHTL extends Reserva{
	...
	static {
		//Este bloque de código de inicialización de variable static podría ser complejo
		//También podría ser substituido por un método static, 
		// la ventaja de inicializar static mediante método static es que se puede rellamar; reinicializar
	...
	//también es private; inaccesible externamente -> la static queda protegida de manipulaciones externas
	...
	// Se podrá obtener el valor de la private static numReservaHtl mediante un método public
