...
public class Leccion_9 {
	...
	public static void main(String[] args) {
		...
		//// En leccion_10_Ejercicio está resuelto con estructura correcta de Packages
		...
		// "TRL/2024/0001",...
		// Pax; máximo 4 Ejemplo; [Tomeu Sabater, Juan Pérez, Pep Gonella, Pepito Pérez]
		// Fecha de Inicio/Llegada y Fecha de Fin/Salida; Ejemplo: 01-Agosto-2026,
		// 	05-Agosto-2026
		...
		// Si es VUE:
		// 	- A/P de salida: Código 3 letras aeropuerto de salida: PMI, BCN, CUN, HAV
		// 	- A/P de llegada: Código 3 letras aeropuerto de llegada: MAD, SVQ, JFK, ATL
		// Si es TRL:
		...
		// Tiene que haber Getters y Setters para cada variable de instancia
		// Tiene que haber un método que muestra el contenido de la reserva
		// Típicamente, habría 5 reservas: 2 x vuelo (ida/vuelta), 2 x traslado (a/p ->
		// hotel, hotel -> a/p), 1 x hotel
		...
		// entradas a museos, parques temáticos y otras atracciones, todo ello se
		// almacena en un único expediente, no trataremos esta estructura
		// por el momento, nos limitamos a Reservas independientes.

		// Se muestra una aproximación (no tiene todas las Sub Class) a una posible
		// Solución:

		// Diseñaremos una Super Class Reserva que contendrá los elementos comunes
		// y 3 Sub Class, para HTL, VUE y TRL cada una con los elemento que les sea
		// particular
		...
		class Reserva {
			...
			// Asigna Pax
			private void asignaPax(String pasajero1, String pasajero2, String pasajero3, String pasajero4) {

				// Pax Names en Upper como estándar
				this.pax[0] = pasajero1.toUpperCase();
		...
		// Realmente, no deberíamos tener ninguna Super Reservas, la instanciamos por
		// motivos de test
		Reserva reserva1 = new Reserva("Tomeu Sabater", null, null, null, "2026-04-16", "2026-04-19", 1000);
		...
		class ReservaHTL extends Reserva {
			...
			// Método constructor
			public ReservaHTL(String pax1, String pax2, String pax3, String pax4, String fInicio, String fFin,
					String direccion, char habitacion, int neto) {

				// Llamamos al constructor de la Super Class Reserva
				super(pax1, pax2, pax3, pax4, fInicio, fFin, neto);

				// Asignamos valores a los atributos particulares de ReservaHTL
			...
			private static String generaNuevoNumeroReserva() {
				...
				String numeroHlt = String.valueOf(++ReservaHTL.numReservaHtl); // Usa una estática

				String numeroReserva = ReservaHTL.TIPO_RESERVA + "/" + sanyo + "/" + numeroHlt;
		...
		System.out.println(
				"Actualmente hay " + ReservaHTL.numReservasHotel() + " Reservas de tipo " + ReservaHTL.ELEMENTO);
		...
		// Si hemos podido alterar el valor porque estamos dentro de la misma class
		// Leccion_9_Ejercicio
		// Para aplicar correctamente el nivel de protección debemos separar cada Class
		// en ficheros separados
		// Realmente, estamos anidando la Super Class y las Sub Class dentro de la Class
		// Leccion_9 y los niveles de protección no actúan como deseamos
		// Lo haremos correctamente en la Lección_10_Ejercicio, junto con las Sub Class
		// para ReservaVUE y ReservaTRL
