...
public class Leccion_5 {
	...
	public static void main(String[] args) {
		...
		class Bicycle {
			...
			// final String ELEMENTO = "Bicycle"; // Es posible, pero es elegante, puesto
			// que es la misma CTE para cada Obj
			...
			// Al poder dificultar el código, solamente se suele usar en constructores o
			// setters
			// para evitar confusiones se utiliza la palabra reservada 'this'
			public Bicycle(String brand, String model, boolean ebike) {

				// java.util.Objects.requireNonNull(brand, "Parámetro 'brand' no puede ser
				// nulo");
				// java.util.Objects.requireNonNull(model, "Parámetro 'model' no puede ser
				// nulo");
		...
		// Pero para ello, no tocaremos su código, sino que aplicaremos el concepto de
		// herencia (Inheritance)
		// Definiremos una nueva Class BicyclePlus que extenderá (mejorará/refinará) la
		// Class Bicycle
		// Bicycle será la Super Class de una nueva Class BicyclePlus
		// Esta nueva Class BicyclePlus contendrá (heredará) todo lo de su Super Class
		// Bicycle, y además, algunos elementos extra
		...
		// Lo siguiente es posible porque estamos en la misma public class Leccion_5
		// bici_plus_1.cadence = 123;
		// bici_plus_1.gear = 4;
		// bici_plus_1.speed = 10;
		// bici_plus_1.changeSpeed(10);
		// Para aplicar correctamente la protección a variables de instancia y métodos
		// hay que generar un fichero específico con la Class Bicycle / BicyclePlus
		// generar el Package leccion_5_Ejercicio y
		// dentro debería tener la Class Bicyle / Class BicyclePlus
		// Ver el ejemplo en el package Leccion_5_Ejercicio
