...
class Leccion_12_Ejercicio {
	...
	public static void main(String[] args) {
		...
		// Hay 2 Inner Class especiales, la Local Class y la Anonymous Class, que
		...
		// (BSB: Funciona como una Static Class pero la definimos como subclase para una
		// mejor arquitectura)

		// Class LocalizadorReserva será una Static Nested Class por lo que no tendrá
		// acceso a los elementos de la class Reserva

		// Comprobamos datos inicales
		// Llamamos a métodos static de la Class Reserva, no hace falta crear ninguna
		// reserva
		System.out.println("*********************************");
		...
		// System.out.println("Nuevo Localizador es :" +
		// LocalizadorReserva.generaLocalizador()); // No es accesible, está
		// oculto en la Class Reserva
		...
		reserva2.muestraReserva(); // Obervamos que el número de reserva ha sido consecutivo

		// Creamos una tercera reserva
		Reserva reserva3 = new Reserva("Pepito Pérez", "2024-08-15");
		reserva3.muestraReserva(); // Obervamos que el número de reserva, no ha sido consecutivo
		...
		// No podemos utilizar los métodos static de la static Class
		// LocalizadorReserva.generaLocalizador() ni acceder a los atributos
		// static localizador o numeroReserva por tanto,
		// no podemos alterar el localizador desde el exterior, está todo
		// oculto dentro de la Class Reserva
		//
		// Por otra parte, al ser LocalizadorReserva una Class static, respeta la
		...
		// Un elemento static pertenece a la Class no al Obj, por tanto, una Sub Class
		// static también pertenecería a la Class que la contiene
		//
		// Finalmente, se ha podido etiquetar la Class LocalizadorReserva como static y
		// private porque es una Class Nested, en caso contrario no es posible.
		...
		// de la propia Class Reserva.
		// El ejemplo mostrado aquí es teórico, en una situación real posiblemente se
		// optaría por esta solución más sencilla donde la Class Reserva tienen
		// variables y métodos static de generación de su localizador
		// a no ser que la gestión del localizador fuera compleja, entonces estaría
		// plenamente justificada la nested Class

		// Intentamos dar una solución más sencilla evitando la Static Nested Class en
...
} // class Leccion_12_Ejercicio -> pasar a Leccion_13.java
